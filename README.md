...
**252 tests** across the things that either move money or produce a published number: the
...
src/
  ...
  *.test.ts    252 tests, colocated with what they cover
```
...
| `npm test` · `npm run typecheck` | 252 tests · strict TypeScript, no emit |
