...
src/
  ...
  *.test.ts    849 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 849 tests · strict TypeScript across engine, page and web app |
...
**849 tests** across the things that either move money or produce a published number: the
