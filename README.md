...
**797 tests** across the things that either move money or produce a published number: the
...
src/
  ...
  *.test.ts    797 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 797 tests · strict TypeScript across engine, page and web app |
