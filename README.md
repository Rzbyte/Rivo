...
src/
  ...
  *.test.ts    944 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 944 tests · strict TypeScript across engine, page and web app |
...
**944 tests** across the things that either move money or produce a published number: the
