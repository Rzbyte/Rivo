...
src/
  ...
  *.test.ts    915 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 915 tests · strict TypeScript across engine, page and web app |
...
**915 tests** across the things that either move money or produce a published number: the
