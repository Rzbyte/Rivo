...
src/
  ...
  *.test.ts    913 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 913 tests · strict TypeScript across engine, page and web app |
...
**913 tests** across the things that either move money or produce a published number: the
