...
src/
  ...
  *.test.ts    848 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 848 tests · strict TypeScript across engine, page and web app |
...
**848 tests** across the things that either move money or produce a published number: the
