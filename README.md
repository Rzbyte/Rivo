...
src/
  ...
  *.test.ts    930 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 930 tests · strict TypeScript across engine, page and web app |
...
**930 tests** across the things that either move money or produce a published number: the
