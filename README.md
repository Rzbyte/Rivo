...
**283 tests** across the things that either move money or produce a published number: the
...
src/
  ...
  *.test.ts    283 tests, colocated with what they cover
```
...
| `npm test` · `npm run typecheck` | 283 tests · strict TypeScript, no emit |
