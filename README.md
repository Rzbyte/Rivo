...
src/
  ...
  *.test.ts    945 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 945 tests · strict TypeScript across engine, page and web app |
...
**945 tests** across the things that either move money or produce a published number: the
