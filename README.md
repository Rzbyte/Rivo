...
**744 tests** across the things that either move money or produce a published number: the
...
src/
  ...
  *.test.ts    744 tests, colocated with what they cover
web/
...
| `npm test` · `npm run typecheck` | 744 tests · strict TypeScript across engine, page and web app |
